...
/* Update by Y. Kovryzhenko (Auburn University Aerospace Department) 
 * to replace Arduino println and print commands with
 * standard printf */

#ifndef ADAFRUIT_SENSOR_HPP
#define ADAFRUIT_SENSOR_HPP
...
public:
  ...
  //virtual char getEvent(sensors_event_t *) = 0;
